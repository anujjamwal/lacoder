//! Coder Agent view placeholder. Real implementation in Phase 1.
...
pub fn coder(window_tab_data: Rc<WindowTabData>) -> impl View {
    ...
    let body = stack((
        text("Coder Agent").style(|s| s.font_size(24.0).font_bold()),
        label(|| {
            "Plan · Trace · Files · Chat · Terminal. Real runner lands in Phase 1."
                .to_string()
        })
    ...
    stack((back, body))
        ...
        .debug_name("Coder Agent (placeholder)")
}
